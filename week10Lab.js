...
//Answer:
//We can give it a class name, id, csss, styles, value, properties
 ...
 * ↓ YOUR CODE HERE ↓ */
          ...
          let myTdEmail = document.createElement('email')
          ...
          myTable.style.border = '5px dotted black'
...
//Answer:  It is more efficient and manageable using JavaScript than HTML.
...
btn.addEventListener("mousemove", () => {
  const rndCol = `rgb(${random(0)} ${random(125)} ${random(255)})`;
